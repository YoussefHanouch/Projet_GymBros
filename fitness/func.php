<?php
$con=mysqli_connect("localhost","root","2125","fitness");
...
if(isset($_POST['pat_submit']))
{
    ...
    if(isset($_POST['tra_submit']))
    {
        ...
        if(isset($_POST['pay_submit']))
        {
            ...
            $query="INSERT INTO `payment`(`Payment_id`, `Amount`, `customer_id`, `payment_type`)
                                VALUES ('$Payment_id','$Amount','$customer_id','$payment_type')";
             $result=mysqli_query($con,$query);
            if($result)
            {
